...
\definecolor{lightergray}{rgb}{0.95,0.95,0.93}
...
\newcommand{\code}[1]{\colorbox{darkgray}{\textcolor{white}{\texttt{#1}}}}

\definecolor{identifier}{HTML}{cf1a0c}
\definecolor{keyword}{HTML}{3a50de}
